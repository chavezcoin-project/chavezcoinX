...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("chavezcoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("chavezcoin://"))
    {
        uri.replace(0, 12, "chavezcoin:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Chavezcoin-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("Chavezcoin-Qt"));
